...
export const CalculatorDisplay = ({ value, className = '', theme, }) => {
    ...
    return (<div className={`text-right p-3 sm:p-4 rounded-lg mb-3 sm:mb-4 ${displayClass} ${className}`}>
      <div className="text-2xl sm:text-3xl font-mono min-h-[1.5rem] sm:min-h-[2rem] flex items-center justify-end overflow-hidden">
        {value || '0'}
      </div>
    </div>);
};
//# sourceMappingURL=CalculatorDisplay.jsx.map