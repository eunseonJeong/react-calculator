...
export const useCalculator = (enableKeyboard = true) => {
    ...
    const handleNumberInput = (prevState, input) => {
        if (prevState.waitingForOperand) {
            return Object.assign(Object.assign({}, prevState), { display: input, waitingForOperand: false });
        }
        return Object.assign(Object.assign({}, prevState), { display: prevState.display === '0' ? input : prevState.display + input });
    };
    const handleDecimalPointInput = (prevState) => {
        if (prevState.waitingForOperand) {
            return Object.assign(Object.assign({}, prevState), { display: '0.', waitingForOperand: false });
        }
        if (prevState.display.indexOf('.') === -1) {
            return Object.assign(Object.assign({}, prevState), { display: prevState.display + '.' });
        }
        return prevState;
    };
    const handleOperationInput = (prevState, operation) => {
        ...
        if (operation === 'CE') {
            return Object.assign(Object.assign({}, prevState), { display: '0' });
        }
        const inputValue = parseFloat(prevState.display);
        if (prevState.previousValue === null) {
            return Object.assign(Object.assign({}, prevState), { previousValue: inputValue, operation, waitingForOperand: true });
        }
        if (prevState.operation && !prevState.waitingForOperand) {
            try {
                ...
                return Object.assign(Object.assign({}, initialState), { display: 'Error' });
            }
        }
        return Object.assign(Object.assign({}, prevState), { operation, waitingForOperand: true });
    };
